...
<div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                    ...
                    <center>
                        ...
                        <img class="img-responsive" style="max-width:100px" src="<?php echo base_url('uploads/qr_image/') . $karyawan->id_karyawan . 'code.png'; ?>" />
                    </center>
                </div>
                <div class="col-sm-3">
                    <div class="description-block">
    ...
    <div class="box box-widget">
                    <?php
                        $params['data'] = $karyawan->id_karyawan;
                        $params['level'] = 'H';
                        $params['size'] = 4;
                        $params['savename'] = FCPATH . "uploads/qr_image/" . $karyawan->id_karyawan . 'code.png';
                    ...
                    <div id="print-area">
                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-blue">
                                <div class="widget-user-image">
                                    <img class="img-responsive" src="<?php echo base_url('uploads/qr_image/') . $karyawan->id_karyawan . 'code.png'; ?>" />
                                </div>
                                <!-- /.widget-user-image -->
                                <h3 class="widget-user-username"><?php echo $karyawan->id_karyawan ?></h3>
                                <h5 class="widget-user-desc"><?php echo $karyawan->nama_karyawan; ?></h5>
                                <button onclick="printDiv('print-area')" class='pull-right'><i class='fa fa-print'></i> Print</button>
                            </div>
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    <li><a href="#">NAMA JABATAN : <?php echo $karyawan->nama_jabatan; ?> </a></li>
                                    <li><a href="#">SHIFT : <?php echo $karyawan->nama_shift; ?> </a></li>
                                    <li><a href="#">PENEMPATAN : <?php echo $karyawan->nama_gedung; ?> </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
